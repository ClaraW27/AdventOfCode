...
namespace AoC
{
    internal class DaySevenPartTwo
    {
        ...
        public void CheckType(string hand)
        {
            ...
            else if (charCounts.Contains(4)) // JJJJQ or QQQQJ
            {
                if (hand.Contains('J'))
                {
                    this.fiveKind.Add(hand);
            ...
            else if (charCounts.Contains(3) && charCounts.Contains(2)) // QQQJJ or JJJQQ
            {
                if (hand.Contains('J'))
                {
                    this.fiveKind.Add(hand);
            ...
            else if (charCounts.Contains(3)) // QQQJ9 or JJJQ8
            {
                if (hand.Contains('J'))
                {
                    this.fourKind.Add(hand);
            ...
            else if (charCounts.Count == 3 && charCounts.Count(c => c == 2) == 2) // QQJJ9 => fourKind, or QQAAJ => QQAAA => fullHouse
            {
                int countJ = 0;
            ...
            else if (charCounts.Count == 4) // QQJ23 or JJ123
            {
                if (hand.Contains('J'))
                {
                    this.threeKind.Add(hand);
